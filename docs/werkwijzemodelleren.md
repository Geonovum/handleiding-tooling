...
Het ReSpec-document van een vastgestelde versie van een standaard publiceren we op docs.geostandaarden. In [publiceren van het IMGeluid EAP-bestand](https://geonovum.atlassian.net/l/cp/Fi0U9bCk) staat een [beschrijving](https://geonovum.atlassian.net/wiki/spaces/IMGeluid/pages/2243657743/Het+wijzigen+en+publiceren+van+een+nieuwe+versie+van+IMGeluid#Het-publiceren-van-de-IMGeluid-standaard) hoe je dit doet.
